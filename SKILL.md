...
4. Explain only the common parameters, return values, lifecycle/events, and failure or security boundaries relevant to the API. Mark implementation guidance as an inference when it goes beyond the official contract.
